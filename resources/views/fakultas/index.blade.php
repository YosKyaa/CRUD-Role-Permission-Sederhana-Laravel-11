...
<br />
    <h1 align="left">Data Fakultas</h1>
    <br />
        ...
        <div class="card-header flex-column flex-md-row pb-0">
            <div class="row">
                <div class="col-12 pt-3 pt-md-0">
                    <div class="col-12">
                        <div class="row">
                            <div class=" col-md-3">
                            <div class="offset-md-3 col-md-0 text-md-end text-center pt-3 pt-md-0">
            ...
            <div class="offcanvas offcanvas-end @if($errors->all()) show @endif" tabindex="-1" id="newrecord"
                ...
                <div class="offcanvas-header">
                    <h5 id="offcanvasEndLabel" class="offcanvas-title">Tambah Data Fakultas</h5>
                ...
                <div class="offcanvas-body my-auto mx-0 flex-grow-1">
                    <form class="add-new-record pt-0 row g-2 fv-plugins-bootstrap5 fv-plugins-framework" id="form-add-new-record" method="POST" action="">
                        ...
                        <div class="col-sm-12 fv-plugins-icon-container">
                            <label class="form-label" for="basicDate">Nama Fakultas</label>
                            <div class="input-group input-group-merge has-validation">
                                <input type="text" class="form-control @error('nama_fakultas') is-invalid @enderror" name="nama_fakultas"
                                    placeholder="Nama Fakultas" value="{{ old('nama_fakultas') }}">
                                @error('nama_fakultas')
                        ...
                        <div class="col-sm-12 fv-plugins-icon-container">
                            <label class="form-label" for="basicDate">kode_fakultas</label>
                            <div class="input-group input-group-merge has-validation">
                                <input type="text" class="form-control @error('kode_fakultas') is-invalid @enderror" name="kode_fakultas" id="kode_fakultas" 
                                    placeholder="Kode Fakultas" value="{{ old('kode_falultas') }}">
                                @error('kode_fakultas')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    $(document).ready(function () {
        var table = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                {
                    render: function (data, type, row, meta) {
                        var html = row.nama_fakultas;
                        return html;
                    }
                },
                {
                    render: function (data, type, row, meta) {
                        var html = row.kode_fakultas;
                        return html;
                    },
