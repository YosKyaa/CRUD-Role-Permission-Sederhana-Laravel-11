                ...
                <div class="row">
                    ...
                    <div class="offcanvas offcanvas-end @if ($errors->all()) show @endif" tabindex="-1"
                        ...
                        <div class="offcanvas-header">
                            <h5 id="offcanvasEndLabel" class="offcanvas-title">Tambah Permission</h5>
                        ...
                        <div class="offcanvas-body my-auto mx-0 flex-grow-1">
                            <form class="add-new-record pt-0 row g-2 fv-plugins-bootstrap5 fv-plugins-framework"
                                ...
                                <div class="col-sm-12 fv-plugins-icon-container">
                                    <label class="form-label" for="">Nama Permission</label>
                                    <div class="input-group input-group-merge has-validation">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" placeholder="Nama Permission" value="{{ old('name') }}">
                                        @error('name')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                var table = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('role-permission.permission.data') }}",
                        data: function(d) {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            render: function(data, type, row, meta) {
                                var html =
                                    `<a class=" text-success" title="Edit" href="{{ url('/permission/edit/` +
